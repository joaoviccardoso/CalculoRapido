import { RealizarCalculos } from "../controller/realizarCalculo.js";
...
export class Templetes {
    exibirCalculos(idDoBtnCalculo) {
        ...
        const calculos = {
            ...
            calculoDeParcelasFinanciamento: { titulo: "Parcelas e Financiamento", campos: ["Valor", "Juros (%)", "Tempo"], id: "btnCalculoDeParcelasFinanciamento" },
            calculoFerias: { titulo: "Cálculo de Férias", campos: ["Salário Base", "Meses Trabalhados"], id: "btnCalculoFerias" },
            salario: { titulo: "13º Salário", campos: ["Salário Base", "Meses Trabalhados"], id: "btnSalario" },
        ...
        if (calculos[idDoBtnCalculo]) {
            ...
            containerExibirCalculo.innerHTML = this.gerarTemplate(titulo, campos, id);

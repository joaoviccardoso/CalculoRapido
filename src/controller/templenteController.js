...
export class TempletesController{
    ...
    exibirCalculos(idDoBtnCalculo) {
        ...
        const calculos = {
            ...
            calculodeparcelasefinanciamentos: { titulo: "Parcelas e Financiamento (Sistema Price)", campos: ["Valor", "Juros (%) Anual", "Tempo em meses"], id: "btnCalculoDeParcelasFinanciamento" },
            ...
            equacaodo1ºgrau: { titulo: "Equação do 1º Grau", campos: ["Coeficiente A", "Coeficiente B"], id: "btnEquacao1Grau" },
